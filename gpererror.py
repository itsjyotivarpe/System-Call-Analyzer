...
ax = plt.subplot(111)
ax.set_title('Percentage Time Taken by Each System Call In Microsecond',fontstyle='italic',color='indigo',size='22')
box = ax.get_position()
ax.set_position([box.x0, box.y0, box.width * 0.80, box.height])


ax.legend(s3,loc='center left', bbox_to_anchor=(1.1, 0.5))
plt.savefig('Graphs/pererrorgr.png',facecolor='Lightgrey',edgecolor='Gray')	
#plt.show()
